...
mlflow.set_tracking_uri("http://0.0.0.0:888")
...
def train_and_log_model(data_path, params):
    ...
    with mlflow.start_run():
        ...
        return mlflow.active_run().info.run_id, test_rmse
...
def run_register_model(data_path: str, top_n: int):
    ...
    if best_run_id:
        ...
        mlflow.register_model(model_uri=model_uri, name="RandomForestRegressor_BestModel")
